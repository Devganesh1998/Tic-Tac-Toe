...
function checkMoveX() {
  if (
    positionX[0] + positionX[1] + positionX[2] == 3 ||
...
function checkMoveY() {
  if (
    positionY[0] + positionY[1] + positionY[2] == 3 ||
